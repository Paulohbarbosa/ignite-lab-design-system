    ...
    <div className="w-screen h-screen bg-gray-900 flex items-center justify-center text-gray-100 flex-col">
      ...
      <footer className="flex flex-col items-center gap-4 mt-8">
        <Text asChild size="sm">
          <a href="" className="tex-gray-400 underline hover:text-gray-200"> Esqueceu a senha?</a>
        </Text>
        <Text asChild size="sm">
          <a href="" className="tex-gray-400 underline hover:text-gray-200"> Eita! Não tenho cadastro!</a>
        </Text>
      </footer>
